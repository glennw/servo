...
impl<'a> CanvasPaintTask<'a> {
    fn new(size: Size2D<i32>,
           webrender_api_sender: Option<webrender_traits::RenderApiSender>) -> CanvasPaintTask<'a> {
    ...
    pub fn start(size: Size2D<i32>,
        ...
        spawn_named("CanvasTask".to_owned(), move || {
            let mut painter = CanvasPaintTask::new(size, webrender_api_sender);
            loop {
